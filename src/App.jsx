...
import { ProductRow } from "./components/products/products";
...
function App() {
	...
	return <div className="container my-3">
				<SearchBar search={search} onSearchChange={setSearch} showStockedOnly = {showStockedOnly} onStockedOnlyChange={setShowStockOnly}/>
